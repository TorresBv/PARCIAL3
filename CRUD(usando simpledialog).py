...
class Registro:
    def __init__(self, root):
        ...
        frame1 = LabelFrame(self.wind, text="REGISTRO", bg="lawngreen", font=("calibri", 14))
        frame2 = LabelFrame(self.wind, text="BASE DE DATOS", bg="lawngreen", font=("calibri", 14))
        ...
        lbl1 = Label(frame1, text="ID Alumno", width=20, bg="palegreen")
        lbl1.grid(row=0, column=0, padx=5, pady=3)
        self.entID = Entry(frame1, textvariable=ID)   
        self.entID.grid(row=0, column=1, padx=5, pady=3) 

        lbl2 = Label(frame1, text="Nombre Del Alumno", width=20, bg="palegreen")
        lbl2.grid(row=1, column=0, padx=5, pady=3)
        self.entNombre = Entry(frame1, textvariable=Nombre)   
        self.entNombre.grid(row=1, column=1, padx=5, pady=3) 

        lbl3 = Label(frame1, text="Edad", width=20, bg="palegreen")
        lbl3.grid(row=2, column=0, padx=5, pady=3)
        self.entEdad = Entry(frame1, textvariable=Edad)   
        self.entEdad.grid(row=2, column=1, padx=5, pady=3) 

        lbl4 = Label(frame1, text="Email", width=20, bg="palegreen")
        lbl4.grid(row=3, column=0, padx=5, pady=3)
        self.entEmail = Entry(frame1, textvariable=Email)   
        self.entEmail.grid(row=3, column=1, padx=5, pady=3)

        btn1 = Button(frame1, text="Agregar", width=12, height=2, bg="lime", command=Agregar)
        btn1.grid(row=6, column=0, padx=10, pady=10)

        btn2 = Button(frame1, text="Eliminar", width=12, height=2, bg="lime", command=Eliminar)
        btn2.grid(row=6, column=1, padx=10, pady=10)

        btn3 = Button(frame1, text="Actualizar", width=12, height=2, bg="lime", command=Actualizar)
        btn3.grid(row=6, column=2, padx=10, pady=10)

        btn4 = Button(frame1, text="Mostrar", width=12, height=2, bg="lime", command=Mostrar)
        btn4.grid(row=6, column=3, padx=10, pady=10)

        btn5 = Button(frame1, text="Limpiar", width=12, height=2, bg="lime", command=Limpiar)
        btn5.grid(row=6, column=4, padx=10, pady=10)

        btn6 = Button(frame1, text="Buscar", width=12, height=2, bg="lime", command=Buscar) 
